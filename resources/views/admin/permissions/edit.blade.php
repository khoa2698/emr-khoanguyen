...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-3">
                <h1 class="m-0">@lang('Edit group of permission')</h1>
            </div>
            <div class="col-sm-9">
    ...
    <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">@lang('Edit group of permission')</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('permission.update', $role->id) }}" method="POST" id="form-1">
            @method('PUT')
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $role->name }}" name="name" id="fullname" placeholder="@lang('Type full name')">
                                            ...
                                            <div class="col-12">
                                                ...
                                                @foreach ($patientPermissions as $patientPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($patientPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $patientPermission->id }}" value="{{ $patientPermission->id }}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                @foreach ($generalExamPermissions as $generalExamPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($generalExamPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $generalExamPermission->id }}" value="{{ $generalExamPermission->id }}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                @foreach ($subExamPermissions as $subExamPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($subExamPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $subExamPermission->id }}" value="{{ $subExamPermission->id }}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                @foreach ($medicalRecordPermissions as $medicalRecordPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($medicalRecordPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $medicalRecordPermission->id }}" value="{{ $medicalRecordPermission->id }}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                @foreach ($paymentPermissions as $paymentPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($paymentPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $paymentPermission->id }}" value="{{ $paymentPermission->id }}">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                @foreach ($appointmentPermissions as $appointmentPermission)
                                                    <div class="custom-control custom-checkbox" style="display:inline-block; margin-left:15px">
                                                        <input {{ $role->hasPermissionTo($appointmentPermission->name) == true ? 'checked' : '' }} class="custom-control-input" type="checkbox" name="permissions[]" id="customCheckbox{{ $appointmentPermission->id }}" value="{{ $appointmentPermission->id }}">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> @lang('Update')</button>
            </div>
        </form>
    </div>
